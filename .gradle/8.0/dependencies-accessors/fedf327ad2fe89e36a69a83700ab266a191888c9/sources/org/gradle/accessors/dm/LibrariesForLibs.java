...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxUiLibraryAccessors extends SubDependencyFactory {
         ...
         */
        public AndroidxUiTextLibraryAccessors getText() { return laccForAndroidxUiTextLibraryAccessors; }
    ...
    public static class AndroidxUiTextLibraryAccessors extends SubDependencyFactory {
         ...
         */
        public AndroidxUiTextGoogleLibraryAccessors getGoogle() { return laccForAndroidxUiTextGoogleLibraryAccessors; }
    ...
    public static class AndroidxUiTextGoogleLibraryAccessors extends SubDependencyFactory {
        ...
        public AndroidxUiTextGoogleLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getFonts() { return create("androidx.ui.text.google.fonts"); }
    ...
    public static class UiVersionAccessors extends VersionFactory  {
        ...
        /**
         * Returns the group of versions at versions.ui.text
         */
        public UiTextVersionAccessors getText() { return vaccForUiTextVersionAccessors; }

    }

    public static class UiTextVersionAccessors extends VersionFactory  {

        private final UiTextGoogleVersionAccessors vaccForUiTextGoogleVersionAccessors = new UiTextGoogleVersionAccessors(providers, config);
        public UiTextVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Returns the group of versions at versions.ui.text.google
         */
        public UiTextGoogleVersionAccessors getGoogle() { return vaccForUiTextGoogleVersionAccessors; }

    }

    public static class UiTextGoogleVersionAccessors extends VersionFactory  {

        public UiTextGoogleVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Returns the version associated to this alias: ui.text.google.fonts (1.4.3)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getFonts() { return getVersion("ui.text.google.fonts"); }
